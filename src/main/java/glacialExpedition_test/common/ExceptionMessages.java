...
public class ExceptionMessages {
    ...
    public static final String EXPLORER_DOES_NOT_EXIST = "Explorer %s doesn't exists.";

    public static final String STATE_EXPLORERS_DOES_NOT_EXISTS = "You must have at least one explorer to explore the state.";
